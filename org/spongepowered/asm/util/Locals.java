...
/*     */ {
/*  63 */   private static final Map<String, List<LocalVariableNode>> calculatedLocalVariables = new HashMap();
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*  82 */         insns.add(new VarInsnNode(locals[pos].getOpcode(21), pos));
/*  83 */         limit--;
/*     */       } 
/*     */     } 
/*     */   }
...
/* 163 */       AbstractInsnNode insn = (AbstractInsnNode)iter.next();
/* 164 */       if (insn instanceof FrameNode) {
/* 165 */         frameIndex++;
/* 166 */         FrameNode frameNode = (FrameNode)insn;
/* 167 */         ClassInfo.FrameData frameData = (frameIndex < frames.size()) ? (ClassInfo.FrameData)frames.get(frameIndex) : null;
/*     */         
...
/*     */ 
/*     */   
/* 239 */   public static LocalVariableNode getLocalVariableAt(ClassNode classNode, MethodNode method, AbstractInsnNode node, int var) { return getLocalVariableAt(classNode, method, method.instructions.indexOf(node), var); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 280 */   private static boolean isOpcodeInRange(InsnList insns, LocalVariableNode local, int pos) { return (insns.indexOf(local.start) < pos && insns.indexOf(local.end) > pos); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 310 */     List<LocalVariableNode> localVars = (List)calculatedLocalVariables.get(methodId);
...
/*     */ 
/*     */     
/* 344 */     Analyzer<BasicValue> analyzer = new Analyzer<BasicValue>(new MixinVerifier(Type.getObjectType(classNode.name), objectType, interfaces, false));
/*     */     try {
...
/*     */ 
/*     */     
/* 352 */     Frame[] frames = analyzer.getFrames();
/*     */ 
/*     */     
...
/* 367 */       Frame<BasicValue> f = frames[i];
/* 368 */       if (f != null) {
/*     */ 
/*     */         
...
/* 419 */           method.instructions.add(label);
/*     */         } 
/*     */         
...
/* 430 */         method.instructions.insert(method.instructions.get(n), labels[n]);
/*     */       }
/*     */     } 
/*     */     
...
/* Location:              D:\工程开发\Cracked\phosphor-1.12.2-0.2.6+build50-universal.jar!\org\spongepowered\as\\util\Locals.class
