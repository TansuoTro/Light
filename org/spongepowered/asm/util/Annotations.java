...
/*     */ 
/*     */   
/* 143 */   public static AnnotationNode getVisible(FieldNode field, Class<? extends Annotation> annotationClass) { return get(field.visibleAnnotations, Type.getDescriptor(annotationClass)); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 155 */   public static AnnotationNode getInvisible(FieldNode field, Class<? extends Annotation> annotationClass) { return get(field.invisibleAnnotations, Type.getDescriptor(annotationClass)); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 167 */   public static AnnotationNode getVisible(MethodNode method, Class<? extends Annotation> annotationClass) { return get(method.visibleAnnotations, Type.getDescriptor(annotationClass)); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 179 */   public static AnnotationNode getInvisible(MethodNode method, Class<? extends Annotation> annotationClass) { return get(method.invisibleAnnotations, Type.getDescriptor(annotationClass)); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 191 */   public static AnnotationNode getSingleVisible(MethodNode method, Class... annotationClasses) { return getSingle(method.visibleAnnotations, annotationClasses); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 203 */   public static AnnotationNode getSingleInvisible(MethodNode method, Class... annotationClasses) { return getSingle(method.invisibleAnnotations, annotationClasses); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 215 */   public static AnnotationNode getVisible(ClassNode classNode, Class<? extends Annotation> annotationClass) { return get(classNode.visibleAnnotations, Type.getDescriptor(annotationClass)); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 227 */   public static AnnotationNode getInvisible(ClassNode classNode, Class<? extends Annotation> annotationClass) { return get(classNode.invisibleAnnotations, Type.getDescriptor(annotationClass)); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 240 */   public static AnnotationNode getVisibleParameter(MethodNode method, Class<? extends Annotation> annotationClass, int paramIndex) { return getParameter(method.visibleParameterAnnotations, Type.getDescriptor(annotationClass), paramIndex); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 253 */   public static AnnotationNode getInvisibleParameter(MethodNode method, Class<? extends Annotation> annotationClass, int paramIndex) { return getParameter(method.invisibleParameterAnnotations, Type.getDescriptor(annotationClass), paramIndex); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */   }
/*     */   
/*     */   private static AnnotationNode getSingle(List<AnnotationNode> annotations, Class[] annotationClasses) {
...
/*     */     }
/*     */     
/* 314 */     return (foundNodes == 0) ? null : (AnnotationNode)nodes.get(0);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 326 */   public static <T> T getValue(AnnotationNode annotation) { return (T)getValue(annotation, "value"); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 342 */     T returnValue = (T)getValue(annotation, key);
...
/* 361 */     T value = (T)getValue(annotation, key);
/* 362 */     if (value == null) {
/*     */       try {
...
/* 415 */     String[] value = (String[])getValue(annotation, key);
/* 416 */     if (value == null) {
/* 417 */       return defaultValue;
/*     */     }
/* 419 */     return (T)toEnumValue(enumClass, value);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 458 */       for (ListIterator<Object> iter = ((List)value).listIterator(); iter.hasNext();) {
/* 459 */         iter.set(toEnumValue(enumClass, (String[])iter.next()));
/*     */       }
/* 461 */       return (List)value;
...
/*     */     }
/* 474 */     return (T)Enum.valueOf(enumClass, value[1]);
/*     */   }
/*     */ }


/* Location:              D:\工程开发\Cracked\phosphor-1.12.2-0.2.6+build50-universal.jar!\org\spongepowered\as\\util\Annotations.class
