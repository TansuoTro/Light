...
/*     */ 
/*     */     
/*  97 */     private static final Pattern pattern = Pattern.compile("^([A-Z0-9\\-_\\.]+)\\((?:(<|<=|>|>=|=)?([0-9]+)(<|(-)([0-9]+)?|>|(\\+)([0-9]+)?)?)?\\)$"); private final String expr;
...
/* 105 */       this.min = Integer.MIN_VALUE;
/*     */       
/* 107 */       this.max = Integer.MAX_VALUE;
/*     */ 
/*     */ 
/*     */ 
/*     */       
...
/*     */ 
/*     */     
/* 192 */     private boolean has(int index) { return (this.constraint[index] != null); }
/*     */ 
/*     */ 
/*     */     
/* 196 */     private String elem(int index) { return this.constraint[index]; }
/*     */ 
/*     */ 
/*     */     
/* 200 */     private int val(int index) { return (this.constraint[index] != null) ? Integer.parseInt(this.constraint[index]) : 0; }
/*     */ 
/*     */     
...
/*     */ 
/*     */     
/* 212 */     public String getToken() { return this.token; }
/*     */ 
/*     */ 
/*     */     
/* 216 */     public int getMin() { return this.min; }
/*     */ 
/*     */ 
/*     */     
/* 220 */     public int getMax() { return this.max; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */     
/* 269 */     public String toString() { return String.format("Constraint(%s [%d-%d])", new Object[] { this.token, Integer.valueOf(this.min), Integer.valueOf(this.max) }); }
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 313 */     String constraints = (String)Annotations.getValue(annotation, "constraints", "");
/* 314 */     return parse(constraints);
/*     */   }
/*     */ }


/* Location:              D:\工程开发\Cracked\phosphor-1.12.2-0.2.6+build50-universal.jar!\org\spongepowered\as\\util\ConstraintParser.class
