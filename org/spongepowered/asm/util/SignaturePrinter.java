...
/*     */ 
/*     */   
/*  82 */   public SignaturePrinter(MemberInfo member) { this(member.name, member.desc); }
/*     */ 
/*     */ 
/*     */   
/*  86 */   public SignaturePrinter(String name, String desc) { this(name, Type.getReturnType(desc), Type.getArgumentTypes(desc)); }
/*     */   
...
/*     */ 
/*     */   
/* 130 */   public String getFormattedArgs() { return appendArgs(new StringBuilder(), true, true).toString(); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/* 137 */   public String getReturnType() { return getTypeName(this.returnType, false, this.fullyQualified); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 188 */   public boolean isFullyQualified() { return this.fullyQualified; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 196 */   public String toString() { return appendArgs((new StringBuilder()).append(this.modifiers).append(" ").append(this.name), false, true).toString(); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 267 */   public static String getTypeName(Type type, boolean box) { return getTypeName(type, box, false); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 303 */   private static String arraySuffix(Type type) { return Strings.repeat("[]", type.getDimensions()); }
/*     */ 
/*     */ 
/*     */   
...
/* Location:              D:\工程开发\Cracked\phosphor-1.12.2-0.2.6+build50-universal.jar!\org\spongepowered\as\\util\SignaturePrinter.class
