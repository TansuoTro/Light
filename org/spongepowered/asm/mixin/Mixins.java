...
/*     */ 
/*     */   
/*  56 */   private static final Set<String> errorHandlers = new LinkedHashSet();
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/*  78 */   public static void addConfiguration(String configFile) { createConfiguration(configFile, MixinEnvironment.getDefaultEnvironment()); }
/*     */ 
/*     */ 
/*     */   
/*     */   @Deprecated
/*  83 */   static void addConfiguration(String configFile, MixinEnvironment fallback) { createConfiguration(configFile, fallback); }
/*     */ 
/*     */ 
/*     */   
...
/* 141 */     mixinConfigs = (Set)GlobalProperties.get("mixin.configs.queue");
/* 142 */     if (mixinConfigs == null) {
/* 143 */       mixinConfigs = new LinkedHashSet();
...
/*     */ 
/*     */   
/* 164 */   public static Set<String> getErrorHandlerClasses() { return Collections.unmodifiableSet(errorHandlers); }
/*     */ }


/* Location:              D:\工程开发\Cracked\phosphor-1.12.2-0.2.6+build50-universal.jar!\org\spongepowered\asm\mixin\Mixins.class
