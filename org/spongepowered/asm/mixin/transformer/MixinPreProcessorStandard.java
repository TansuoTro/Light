...
/*     */   {
/*  95 */     MERGE(true),
/*  96 */     OVERWRITE(true, org.spongepowered.asm.mixin.Overwrite.class),
/*  97 */     SHADOW(false, org.spongepowered.asm.mixin.Shadow.class),
/*  98 */     ACCESSOR(false, org.spongepowered.asm.mixin.gen.Accessor.class),
/*  99 */     INVOKER(false, org.spongepowered.asm.mixin.gen.Invoker.class);
/*     */     
...
/*     */ 
/*     */     
/* 121 */     public String toString() { return this.description; }
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 143 */     this.profiler = MixinEnvironment.getProfiler();
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 190 */     AnnotationNode shadowAnnotation = Annotations.getVisible(mixinMethod, org.spongepowered.asm.mixin.Shadow.class);
/* 191 */     if (shadowAnnotation == null) {
/*     */       return;
/*     */     }
/*     */     
/* 195 */     String prefix = (String)Annotations.getValue(shadowAnnotation, "prefix", org.spongepowered.asm.mixin.Shadow.class);
/* 196 */     if (mixinMethod.name.startsWith(prefix)) {
/* 197 */       Annotations.setVisible(mixinMethod, org.spongepowered.asm.mixin.transformer.meta.MixinRenamed.class, new Object[] { "originalName", mixinMethod.name });
...
/*     */ 
/*     */   
/* 216 */   final MixinPreProcessorStandard conform(TargetClassContext target) { return conform(target.getClassInfo()); }
/*     */ 
/*     */   
...
/* 276 */       MixinInfo.MixinMethodNode mixinMethod = (MixinInfo.MixinMethodNode)iter.next();
/*     */       
...
/*     */ 
/*     */   
/* 315 */   protected boolean validateMethod(MixinTargetContext context, MixinInfo.MixinMethodNode mixinMethod) { return true; }
/*     */ 
/*     */ 
/*     */   
/* 319 */   protected boolean attachInjectorMethod(MixinTargetContext context, MixinInfo.MixinMethodNode mixinMethod) { return mixinMethod.isInjector(); }
/*     */ 
/*     */   
...
/*     */ 
/*     */   
/* 360 */   protected boolean attachShadowMethod(MixinTargetContext context, MixinInfo.MixinMethodNode mixinMethod) { return attachSpecialMethod(context, mixinMethod, SpecialMethod.SHADOW); }
/*     */ 
/*     */ 
/*     */   
/* 364 */   protected boolean attachOverwriteMethod(MixinTargetContext context, MixinInfo.MixinMethodNode mixinMethod) { return attachSpecialMethod(context, mixinMethod, SpecialMethod.OVERWRITE); }
/*     */ 
/*     */ 
/*     */   
...
/*     */     } 
/*     */     
/* 472 */     MethodNode target = context.findMethod(mixinMethod, null);
/* 473 */     if (target == null) {
/* 474 */       return false;
/*     */     }
/*     */     
...
/*     */     }
/*     */     
/* 492 */     AnnotationNode unique = Annotations.getVisible(mixinMethod, org.spongepowered.asm.mixin.Unique.class);
...
/*     */     }
/*     */     
/* 530 */     MethodNode target = context.findMethod(mixinMethod, null);
/* 531 */     if (target != null) {
...
/* 538 */       FieldNode mixinField = (FieldNode)iter.next();
/* 539 */       AnnotationNode shadow = Annotations.getVisible(mixinField, org.spongepowered.asm.mixin.Shadow.class);
...
/*     */ 
/*     */     
/* 638 */     String prefix = (String)Annotations.getValue(shadow, "prefix", org.spongepowered.asm.mixin.Shadow.class);
...
/* 668 */         AbstractInsnNode insn = (AbstractInsnNode)iter.next();
...
/*     */ 
/*     */   
/* 718 */   protected static String getDynamicInfo(MethodNode method) { return getDynamicInfo("Method", Annotations.getInvisible(method, org.spongepowered.asm.mixin.Dynamic.class)); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 731 */   protected static String getDynamicInfo(FieldNode method) { return getDynamicInfo("Field", Annotations.getInvisible(method, org.spongepowered.asm.mixin.Dynamic.class)); }
/*     */ 
/*     */   
...
/* Location:              D:\工程开发\Cracked\phosphor-1.12.2-0.2.6+build50-universal.jar!\org\spongepowered\asm\mixin\transformer\MixinPreProcessorStandard.class
