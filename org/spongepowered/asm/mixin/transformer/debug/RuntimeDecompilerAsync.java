...
/*    */ {
/* 38 */   private final BlockingQueue<File> queue = new LinkedBlockingQueue();
/*    */   
...
/* 64 */     while (this.run) {
/*    */       try {
/* 66 */         File file = (File)this.queue.take();
...
/* 85 */     while ((file = (File)this.queue.poll()) != null)
/* 86 */       decompile(file); 
/*    */   }
/*    */ }


/* Location:              D:\工程开发\Cracked\phosphor-1.12.2-0.2.6+build50-universal.jar!\org\spongepowered\asm\mixin\transformer\debug\RuntimeDecompilerAsync.class
