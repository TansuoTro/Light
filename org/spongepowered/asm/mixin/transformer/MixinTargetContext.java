...
/*  123 */     this.innerClasses = HashBiMap.create();
/*      */ 
/*      */ 
/*      */ 
/*      */     
/*  128 */     this.shadowMethods = new ArrayList();
/*      */ 
/*      */ 
/*      */ 
/*      */     
/*  133 */     this.shadowFields = new LinkedHashMap();
/*      */ 
/*      */ 
/*      */ 
/*      */     
/*  138 */     this.mergedMethods = new ArrayList();
/*      */ 
/*      */ 
/*      */ 
/*      */     
/*  143 */     this.injectorGroups = new InjectorGroupInfo.Map();
/*      */ 
/*      */ 
/*      */ 
/*      */     
/*  148 */     this.injectors = new ArrayList();
/*      */ 
/*      */ 
/*      */ 
/*      */     
/*  153 */     this.accessors = new ArrayList();
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */     
/*  174 */     this.minRequiredClassVersion = MixinEnvironment.CompatibilityLevel.JAVA_6.classVersion();
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/*  206 */   void addShadowMethod(MethodNode method) { this.shadowMethods.add(method); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/*  216 */   void addShadowField(FieldNode fieldNode, ClassInfo.Field fieldInfo) { this.shadowFields.put(fieldNode, fieldInfo); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/*  226 */   void addAccessorMethod(MethodNode method, Class<? extends Annotation> type) { this.accessors.add(AccessorInfo.of(this, method, type)); }
/*      */ 
/*      */   
/*      */   void addMixinMethod(MethodNode method) {
/*  230 */     Annotations.setVisible(method, org.spongepowered.asm.mixin.transformer.meta.MixinMerged.class, new Object[] { "mixin", getClassName() });
...
/*      */     
/*  244 */     Annotations.setVisible(method, org.spongepowered.asm.mixin.transformer.meta.MixinMerged.class, new Object[] { "mixin", 
...
/*      */ 
/*      */   
/*  255 */   public String toString() { return this.mixin.toString(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/*  264 */   public MixinEnvironment getEnvironment() { return this.mixin.getParent().getEnvironment(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/*  273 */   public boolean getOption(MixinEnvironment.Option option) { return getEnvironment().getOption(option); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/*  283 */   public ClassNode getClassNode() { return this.classNode; }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/*  293 */   public String getClassName() { return this.mixin.getClassName(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/*  302 */   public String getClassRef() { return this.mixin.getClassRef(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/*  311 */   public TargetClassContext getTarget() { return this.targetClass; }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/*  322 */   public String getTargetClassRef() { return getTarget().getClassRef(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/*  331 */   public ClassNode getTargetClassNode() { return getTarget().getClassNode(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/*  340 */   public ClassInfo getTargetClassInfo() { return this.targetClassInfo; }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/*  350 */   protected ClassInfo getClassInfo() { return this.mixin.getClassInfo(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/*  359 */   public ClassSignature getSignature() { return getClassInfo().getSignature(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/*  368 */   public SourceMap.File getStratum() { return this.stratum; }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
/*      */ 
/*      */   
/*  375 */   public int getMinRequiredClassVersion() { return this.minRequiredClassVersion; }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/*  385 */   public int getDefaultRequiredInjections() { return this.mixin.getParent().getDefaultRequiredInjections(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/*  394 */   public String getDefaultInjectorGroup() { return this.mixin.getParent().getDefaultInjectorGroup(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/*  403 */   public int getMaxShiftByValue() { return this.mixin.getParent().getMaxShiftByValue(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/*  412 */   public InjectorGroupInfo.Map getInjectorGroups() { return this.injectorGroups; }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/*  421 */   public boolean requireOverwriteAnnotations() { return this.mixin.getParent().requireOverwriteAnnotations(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  463 */       AbstractInsnNode insn = (AbstractInsnNode)iter.next();
/*      */       
/*  465 */       if (insn instanceof MethodInsnNode) {
/*  466 */         transformMethodRef(method, iter, new MemberRef.Method((MethodInsnNode)insn));
/*  467 */       } else if (insn instanceof FieldInsnNode) {
/*  468 */         transformFieldRef(method, iter, new MemberRef.Field((FieldInsnNode)insn));
...
/*  490 */     if (Annotations.getInvisible(method, org.spongepowered.asm.mixin.SoftOverride.class) != null) {
...
/*  600 */       FieldNode shadowFieldNode = (FieldNode)shadow.getKey();
/*  601 */       if (!shadowFieldNode.desc.equals(fieldNode.desc) || !shadowFieldNode.name.equals(fieldNode.name)) {
/*      */         continue;
/*      */       }
/*  604 */       ClassInfo.Field shadowField = (ClassInfo.Field)shadow.getValue();
...
/*      */ 
/*      */   
/*  666 */   private void transformConstantNode(MethodNode method, Iterator<AbstractInsnNode> iter, LdcInsnNode ldcInsn) { ldcInsn.cst = transformConstant(method, iter, ldcInsn.cst); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  718 */       transformFieldRef(method, iter, memberRef);
/*      */     } else {
/*  720 */       transformMethodRef(method, iter, memberRef);
/*      */     } 
...
/*      */ 
/*      */     
/*  753 */     if (Annotations.getInvisible(method, org.spongepowered.asm.mixin.SoftOverride.class) == null) {
...
/*      */ 
/*      */     
/*  758 */     for (Iterator<AbstractInsnNode> methodIter = method.instructions.iterator(method.instructions.indexOf(fieldInsn)); methodIter.hasNext(); ) {
/*  759 */       AbstractInsnNode insn = (AbstractInsnNode)methodIter.next();
...
/*  764 */           updateStaticBinding(method, new MemberRef.Method(methodNode));
/*      */           
/*      */           return;
/*      */         } 
/*      */       } 
...
/*      */ 
/*      */   
/*  781 */   private void updateStaticBinding(MethodNode method, MemberRef methodRef) { updateBinding(method, methodRef, ClassInfo.Traversal.SUPER); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/*  792 */   private void updateDynamicBinding(MethodNode method, MemberRef methodRef) { updateBinding(method, methodRef, ClassInfo.Traversal.ALL); }
/*      */ 
/*      */   
...
/*      */ 
/*      */   
/*  933 */   public Target getTargetMethod(MethodNode method) { return getTarget().getTargetMethod(method); }
/*      */ 
/*      */   
...
/*  940 */       List<String> aka = (List)Annotations.getValue(annotation, "aliases");
/*  941 */       if (aka != null) {
...
/*  965 */     if (shadow != null) {
/*  966 */       List<String> aka = (List)Annotations.getValue(shadow, "aliases");
/*  967 */       if (aka != null) {
...
/*      */ 
/*      */   
/* 1009 */   public Extensions getExtensions() { return this.targetClass.getExtensions(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/* 1017 */   public IMixinInfo getMixin() { return this.mixin; }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
/*      */ 
/*      */   
/* 1024 */   MixinInfo getInfo() { return this.mixin; }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/* 1034 */   public int getPriority() { return this.mixin.getPriority(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/* 1043 */   public Set<String> getInterfaces() { return this.mixin.getInterfaces(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/* 1052 */   public Collection<MethodNode> getShadowMethods() { return this.shadowMethods; }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/* 1061 */   public List<MethodNode> getMethods() { return this.classNode.methods; }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/* 1070 */   public Set<Map.Entry<FieldNode, ClassInfo.Field>> getShadowFields() { return this.shadowFields.entrySet(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/* 1079 */   public List<FieldNode> getFields() { return this.classNode.fields; }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/* 1088 */   public Level getLoggingLevel() { return this.mixin.getLoggingLevel(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/* 1098 */   public boolean shouldSetSourceFile() { return this.mixin.getParent().shouldSetSourceFile(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/* 1107 */   public String getSourceFile() { return this.classNode.sourceFile; }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/* 1116 */   public IReferenceMapper getReferenceMapper() { return this.mixin.getParent().getReferenceMapper(); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/* 1126 */   public void preApply(String transformedName, ClassNode targetClass) { this.mixin.preApply(transformedName, targetClass); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/* 1158 */   public String getUniqueName(MethodNode method, boolean preservePrefix) { return getTarget().getUniqueName(method, preservePrefix); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/* 1169 */   public String getUniqueName(FieldNode field) { return getTarget().getUniqueName(field); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/* Location:              D:\工程开发\Cracked\phosphor-1.12.2-0.2.6+build50-universal.jar!\org\spongepowered\asm\mixin\transformer\MixinTargetContext.class
