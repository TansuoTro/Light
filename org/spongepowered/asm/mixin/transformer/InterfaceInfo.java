...
/*     */ 
/*     */   
/* 124 */   public String getPrefix() { return this.prefix; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 133 */   public Type getIface() { return this.iface; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 142 */   public String getName() { return this.iface.getClassName(); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 151 */   public String getInternalName() { return this.iface.getInternalName(); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 160 */   public boolean isUnique() { return this.unique; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */     }
/*     */     
/* 195 */     Annotations.setVisible(method, org.spongepowered.asm.mixin.transformer.meta.MixinRenamed.class, new Object[] { "originalName", method.name, "isInterfaceMember", Boolean.valueOf(true) });
...
/*     */     }
/*     */     
/* 212 */     if (Annotations.getVisible(method, org.spongepowered.asm.mixin.Unique.class) == null) {
/* 213 */       Annotations.setVisible(method, org.spongepowered.asm.mixin.Unique.class, new Object[0]);
...
/*     */   
/*     */   public int hashCode() {
/* 254 */     result = this.mixin.hashCode();
/* 255 */     result = 31 * result + this.prefix.hashCode();
/* 256 */     return 31 * result + this.iface.hashCode();
/*     */   }
/*     */ }


/* Location:              D:\工程开发\Cracked\phosphor-1.12.2-0.2.6+build50-universal.jar!\org\spongepowered\asm\mixin\transformer\InterfaceInfo.class
