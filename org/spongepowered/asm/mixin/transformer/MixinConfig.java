...
/*     */ 
/*     */   
/* 133 */   private static final Set<String> globalMixinList = new HashSet();
/*     */ 
/*     */ 
/*     */ 
/*     */   
...
/*     */ 
/*     */   
/* 143 */   private final Map<String, List<MixinInfo>> mixinMapping = new HashMap();
/*     */ 
/*     */ 
/*     */ 
/*     */   
/* 148 */   private final Set<String> unhandledTargets = new HashSet();
/*     */ 
/*     */ 
/*     */ 
/*     */   
/* 153 */   private final List<MixinInfo> mixins = new ArrayList();
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 250 */   private final int order = configOrder++;
/*     */   
/* 252 */   private final List<IListener> listeners = new ArrayList();
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/*     */   private IMixinConfigPlugin plugin;
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 328 */     this.required &= (!this.env.getOption(MixinEnvironment.Option.IGNORE_REQUIRED));
...
/*     */ 
/*     */   
/* 432 */   void addListener(IListener listener) { this.listeners.add(listener); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */     } 
/*     */     
/* 470 */     this.refMapper = ReferenceMapper.read(this.refMapperConfig);
...
/* 526 */       MixinInfo mixin = (MixinInfo)iter.next();
/*     */       try {
/* 528 */         mixin.validate();
...
/* 533 */         this.logger.error(ex.getMixin() + ": " + ex.getMessage(), ex);
...
/* 584 */           throw ex;
/*     */         }
/* 586 */         this.logger.error(ex.getMessage(), ex);
...
/*     */ 
/*     */   
/* 597 */   void postApply(String transformedName, ClassNode targetClass) { this.unhandledTargets.remove(transformedName); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 615 */   public boolean isRequired() throws MixinInitialisationError { return this.required; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 624 */   public MixinEnvironment getEnvironment() { return this.env; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 632 */   public String getName() { return this.name; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 640 */   public String getMixinPackage() { return this.mixinPackage; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 648 */   public int getPriority() { return this.priority; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 656 */   public int getDefaultMixinPriority() { return this.mixinPriority; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 666 */   public int getDefaultRequiredInjections() { return this.injectorOptions.defaultRequireValue; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 686 */   public boolean conformOverwriteVisibility() throws MixinInitialisationError { return this.overwriteOptions.conformAccessModifiers; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 696 */   public boolean requireOverwriteAnnotations() throws MixinInitialisationError { return this.overwriteOptions.requireOverwriteAnnotations; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 708 */   public int getMaxShiftByValue() { return Math.min(Math.max(this.injectorOptions.maxShiftBy, 0), 5); }
/*     */ 
/*     */ 
/*     */   
...
/*     */ 
/*     */   
/* 719 */   boolean isVisited() throws MixinInitialisationError { return this.visited; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 728 */   int getDeclaredMixinCount() { return getCollectionSize(new Collection[] { this.mixinClasses, this.mixinClassesClient, this.mixinClassesServer }); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 737 */   int getMixinCount() { return this.mixins.size(); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/* 744 */   public List<String> getClasses() { return Collections.unmodifiableList(this.mixinClasses); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 752 */   public boolean shouldSetSourceFile() throws MixinInitialisationError { return this.setSourceFile; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 760 */       return ReferenceMapper.DEFAULT_MAPPER;
/*     */     }
...
/*     */ 
/*     */   
/* 771 */   String remapClassName(String className, String reference) { return getReferenceMapper().remap(className, reference); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 779 */   public IMixinConfigPlugin getPlugin() { return this.plugin; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 787 */   public Set<String> getTargets() { return Collections.unmodifiableSet(this.mixinMapping.keySet()); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/* 794 */   public Set<String> getUnhandledTargets() { return Collections.unmodifiableSet(this.unhandledTargets); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/* 801 */   public Level getLoggingLevel() { return this.verboseLogging ? Level.INFO : Level.DEBUG; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 812 */   public boolean packageMatch(String className) { return className.startsWith(this.mixinPackage); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 823 */   public boolean hasMixinsFor(String targetClass) { return this.mixinMapping.containsKey(targetClass); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 833 */   public List<MixinInfo> getMixinsFor(String targetClass) { return mixinsFor(targetClass); }
/*     */ 
/*     */   
/*     */   private List<MixinInfo> mixinsFor(String targetClass) {
/* 837 */     List<MixinInfo> mixins = (List)this.mixinMapping.get(targetClass);
/* 838 */     if (mixins == null) {
...
/* 854 */       MixinInfo mixin = (MixinInfo)iter.next();
...
/*     */ 
/*     */   
/* 865 */   public String toString() { return this.name; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              D:\工程开发\Cracked\phosphor-1.12.2-0.2.6+build50-universal.jar!\org\spongepowered\asm\mixin\transformer\MixinConfig.class
