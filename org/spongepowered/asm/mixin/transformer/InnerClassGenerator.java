...
/*     */ 
/*     */     
/*  99 */     String getName() { return this.name; }
/*     */ 
/*     */ 
/*     */     
/* 103 */     String getOriginalName() { return this.originalName; }
/*     */ 
/*     */ 
/*     */     
/* 107 */     MixinInfo getOwner() { return this.owner; }
/*     */ 
/*     */ 
/*     */     
/* 111 */     MixinTargetContext getTarget() { return this.target; }
/*     */ 
/*     */ 
/*     */     
/* 115 */     String getOwnerName() { return this.ownerName; }
/*     */ 
/*     */ 
/*     */     
/* 119 */     String getTargetName() { return this.targetName; }
/*     */ 
/*     */ 
/*     */     
/* 123 */     byte[] getClassBytes() throws ClassNotFoundException, IOException { return MixinService.getService().getBytecodeProvider().getClassBytes(this.originalName, true); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */     
/* 159 */     public String toString() { return this.name; }
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 216 */   private final Map<String, String> innerClassNames = new HashMap();
/*     */ 
/*     */ 
/*     */ 
/*     */   
/* 221 */   private final Map<String, InnerClassInfo> innerClasses = new HashMap();
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 231 */     String ref = (String)this.innerClassNames.get(id);
/* 232 */     if (ref == null) {
...
/* 249 */     InnerClassInfo info = (InnerClassInfo)this.innerClasses.get(ref);
/* 250 */     if (info != null) {
...
/* 268 */       cr.accept(new InnerClassAdapter(mixinClassWriter, info), 8);
...
/* Location:              D:\工程开发\Cracked\phosphor-1.12.2-0.2.6+build50-universal.jar!\org\spongepowered\asm\mixin\transformer\InnerClassGenerator.class
