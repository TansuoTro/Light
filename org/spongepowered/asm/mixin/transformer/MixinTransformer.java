...
/*     */   
/*     */   final abstract enum ErrorPhase
/*     */   {
/*     */     PREPARE, APPLY;
...
/*     */     static  {
/*     */       // Byte code:
/*     */       //   0: new org/spongepowered/asm/mixin/transformer/MixinTransformer$ErrorPhase$1
/*     */       //   3: dup
/*     */       //   4: ldc 'PREPARE'
/*     */       //   6: iconst_0
/*     */       //   7: invokespecial <init> : (Ljava/lang/String;I)V
/*     */       //   10: putstatic org/spongepowered/asm/mixin/transformer/MixinTransformer$ErrorPhase.PREPARE : Lorg/spongepowered/asm/mixin/transformer/MixinTransformer$ErrorPhase;
/*     */       //   13: new org/spongepowered/asm/mixin/transformer/MixinTransformer$ErrorPhase$2
/*     */       //   16: dup
/*     */       //   17: ldc 'APPLY'
/*     */       //   19: iconst_1
/*     */       //   20: invokespecial <init> : (Ljava/lang/String;I)V
/*     */       //   23: putstatic org/spongepowered/asm/mixin/transformer/MixinTransformer$ErrorPhase.APPLY : Lorg/spongepowered/asm/mixin/transformer/MixinTransformer$ErrorPhase;
/*     */       //   26: iconst_2
/*     */       //   27: anewarray org/spongepowered/asm/mixin/transformer/MixinTransformer$ErrorPhase
/*     */       //   30: dup
/*     */       //   31: iconst_0
/*     */       //   32: getstatic org/spongepowered/asm/mixin/transformer/MixinTransformer$ErrorPhase.PREPARE : Lorg/spongepowered/asm/mixin/transformer/MixinTransformer$ErrorPhase;
/*     */       //   35: aastore
/*     */       //   36: dup
/*     */       //   37: iconst_1
/*     */       //   38: getstatic org/spongepowered/asm/mixin/transformer/MixinTransformer$ErrorPhase.APPLY : Lorg/spongepowered/asm/mixin/transformer/MixinTransformer$ErrorPhase;
/*     */       //   41: aastore
/*     */       //   42: putstatic org/spongepowered/asm/mixin/transformer/MixinTransformer$ErrorPhase.$VALUES : [Lorg/spongepowered/asm/mixin/transformer/MixinTransformer$ErrorPhase;
/*     */       //   45: return
/*     */       // Line number table:
...
/*     */     }
/*     */     
/* 126 */     ErrorPhase() { this.text = name().toLowerCase(); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */     
/* 134 */     public String getLogMessage(String context, InvalidMixinException ex, IMixinInfo mixin) { return String.format("Mixin %s failed %s: %s %s", new Object[] { this.text, getContext(mixin, context), ex.getClass().getName(), ex.getMessage() }); }
/*     */ 
/*     */ 
/*     */     
/* 138 */     public String getErrorMessage(IMixinInfo mixin, IMixinConfig config, MixinEnvironment.Phase phase) { return String.format("Mixin [%s] from phase [%s] in config [%s] FAILED during %s", new Object[] { mixin, phase, config, name() }); }
/*     */ 
/*     */ 
/*     */     
...
/*     */ 
/*     */   
/* 159 */   private final List<MixinConfig> configs = new ArrayList();
/*     */ 
/*     */ 
/*     */ 
/*     */   
/* 164 */   private final List<MixinConfig> pendingConfigs = new ArrayList();
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 225 */     if (globalMixinTransformer instanceof org.spongepowered.asm.service.ITransformer) {
/* 226 */       throw new MixinException("Terminating MixinTransformer instance " + this);
/*     */     }
/*     */ 
/*     */     
/* 230 */     environment.setActiveTransformer(this);
/*     */     
...
/*     */     
/* 238 */     this.extensions.add(new ArgsClassGenerator());
/* 239 */     this.extensions.add(new InnerClassGenerator());
/*     */     
/* 241 */     this.extensions.add(new ExtensionClassExporter(environment));
/* 242 */     this.extensions.add(new ExtensionCheckClass());
/* 243 */     this.extensions.add(new ExtensionCheckInterfaces());
/*     */     
...
/*     */ 
/*     */       
/* 257 */       Class<? extends IHotSwap> clazz = Class.forName("org.spongepowered.tools.agent.MixinAgent");
/* 258 */       Constructor<? extends IHotSwap> ctor = clazz.getDeclaredConstructor(new Class[] { MixinTransformer.class });
/* 259 */       return (IHotSwap)ctor.newInstance(new Object[] { this });
...
/* 294 */         auditLogger.error("Could not force-load " + target, ex);
/*     */       } 
/*     */     } 
/*     */     
...
/*     */ 
/*     */       
/* 367 */       Map<String, Long> times = (Map)mdGetTimes.invoke(null, new Object[0]);
/*     */       
...
/*     */ 
/*     */   
/* 408 */   public String getName() { return getClass().getName(); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 417 */   public boolean isDelegationExcluded() { return true; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */     
/* 447 */     mixinTimer = this.profiler.begin("mixin");
/*     */     
/* 449 */     if (!locked) {
/*     */       try {
...
/*     */         
/* 493 */         if (locked) {
/* 494 */           logger.warn("Re-entrance detected, this will cause serious problems.", new MixinException());
...
/* 602 */       Config handle = (Config)iter.next();
/*     */       try {
...
/*     */ 
/*     */   
/* 724 */   private void apply(TargetClassContext context) { context.applyMixins(); }
/*     */ 
/*     */ 
/*     */   
/* 728 */   private void handleMixinPrepareError(MixinConfig config, InvalidMixinException ex, MixinEnvironment environment) throws MixinPrepareError { handleMixinError(config.getName(), ex, environment, ErrorPhase.PREPARE); }
/*     */ 
/*     */ 
/*     */   
/* 732 */   private void handleMixinApplyError(String targetClass, InvalidMixinException ex, MixinEnvironment environment) throws MixinApplyError { handleMixinError(targetClass, ex, environment, ErrorPhase.APPLY); }
/*     */ 
/*     */   
...
/*     */     
/* 740 */     if (mixin == null) {
/* 741 */       logger.error("InvalidMixinException has no mixin!", ex);
/* 742 */       throw ex;
/*     */     } 
/*     */     
...
/*     */     } 
/*     */     
/* 774 */     logger.log(action.logLevel, errorPhase.getLogMessage(context, ex, mixin), ex);
/*     */     
...
/*     */ 
/*     */   
/* 803 */   private byte[] writeClass(TargetClassContext context) { return writeClass(context.getClassName(), context.getClassNode(), context.isExportForced()); }
/*     */ 
/*     */ 
/*     */   
...
/* Location:              D:\工程开发\Cracked\phosphor-1.12.2-0.2.6+build50-universal.jar!\org\spongepowered\asm\mixin\transformer\MixinTransformer.class
