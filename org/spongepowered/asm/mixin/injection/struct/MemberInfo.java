...
/*     */   
/* 123 */   public MemberInfo(String name, boolean matchAll) { this(name, null, null, matchAll); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 136 */   public MemberInfo(String name, String owner, boolean matchAll) { this(name, owner, null, matchAll); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 148 */   public MemberInfo(String name, String owner, String desc) { this(name, owner, desc, false); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 161 */   public MemberInfo(String name, String owner, String desc, boolean matchAll) { this(name, owner, desc, matchAll, null); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 356 */   public IMapping<?> asMapping() { return isField() ? asFieldMapping() : asMethodMapping(); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 391 */   public boolean isFullyQualified() { return (this.owner != null && this.name != null && this.desc != null); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 401 */   public boolean isField() { return (this.forceField || (this.desc != null && !this.desc.startsWith("("))); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 410 */   public boolean isConstructor() { return "<init>".equals(this.name); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 419 */   public boolean isClassInitialiser() { return "<clinit>".equals(this.name); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 429 */   public boolean isInitialiser() { return (isConstructor() || isClassInitialiser()); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 501 */   public boolean matches(String owner, String name, String desc) { return matches(owner, name, desc, 0); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 539 */   public boolean matches(String name, String desc) { return matches(name, desc, 0); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 580 */   public int hashCode() { return Objects.hashCode(new Object[] { Boolean.valueOf(this.matchAll), this.owner, this.name, this.desc }); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 615 */   public MemberInfo remapUsing(MappingMethod srgMethod, boolean setOwner) { return new MemberInfo(this, srgMethod, setOwner); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 625 */   public static MemberInfo parseAndValidate(String string) { return parse(string, null, null).validate(); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 636 */   public static MemberInfo parseAndValidate(String string, IMixinContext context) throws InvalidMemberDescriptorException { return parse(string, context.getReferenceMapper(), context.getClassRef()).validate(); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 646 */   public static MemberInfo parse(String string) { return parse(string, null, null); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 657 */   public static MemberInfo parse(String string, IMixinContext context) throws InvalidMemberDescriptorException { return parse(string, context.getReferenceMapper(), context.getClassRef()); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 721 */   public static MemberInfo fromMapping(IMapping<?> mapping) { return new MemberInfo(mapping); }
/*     */ }


/* Location:              D:\工程开发\Cracked\phosphor-1.12.2-0.2.6+build50-universal.jar!\org\spongepowered\asm\mixin\injection\struct\MemberInfo.class
