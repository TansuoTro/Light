...
/*     */ 
/*     */   
/* 120 */   public boolean hasDescriptor() { return (this.desc != null); }
/*     */ 
/*     */ 
/*     */ 
/*     */   
...
/* 130 */     Collection<AbstractInsnNode> candidates = (this.desc != null) ? newNodes : nodes;
/* 131 */     ListIterator<AbstractInsnNode> iter = insns.iterator();
/* 132 */     while (iter.hasNext()) {
/* 133 */       AbstractInsnNode insn = (AbstractInsnNode)iter.next();
/*     */       
...
/* 158 */     int indexOf = insns.indexOf(newNode);
/* 159 */     for (Iterator<AbstractInsnNode> iter = insns.iterator(indexOf); iter.hasNext(); ) {
/* 160 */       AbstractInsnNode insn = (AbstractInsnNode)iter.next();
...
/*     */ 
/*     */   
/* 172 */   private boolean matchesOwner(TypeInsnNode insn) { return (this.target == null || this.target.equals(insn.desc)); }
/*     */ }


/* Location:              D:\工程开发\Cracked\phosphor-1.12.2-0.2.6+build50-universal.jar!\org\spongepowered\asm\mixin\injection\points\BeforeNew.class
