...
/*     */ 
/*     */       
/*  87 */       public String toString() { return String.format("Local[ordinal=%d, name=%s, type=%s]", new Object[] { Integer.valueOf(this.ord), this.name, this.type }); }
/*     */     }
/*     */ 
/*     */ 
/*     */ 
...
/* 137 */         if (locals != null) {
/* 138 */           Local[] arrayOfLocal1 = new Local[locals.length];
/* 139 */           for (int l = 0; l < locals.length; l++) {
/* 140 */             if (locals[l] != null) {
/* 141 */               arrayOfLocal1[l] = new Local((locals[l]).name, Type.getType((locals[l]).desc));
/*     */             }
/*     */           } 
...
/*     */       } 
/*     */       
/* 148 */       Local[] arrayOfLocal = new Local[this.baseArgIndex + target.arguments.length];
/* 149 */       if (!this.isStatic) {
/* 150 */         arrayOfLocal[0] = new Local("this", Type.getType(target.classNode.name));
/*     */       }
/* 152 */       for (int local = this.baseArgIndex; local < arrayOfLocal.length; local++) {
/* 153 */         Type arg = target.arguments[local - this.baseArgIndex];
/* 154 */         arrayOfLocal[local] = new Local("arg" + local, arg);
/*     */       } 
...
/* 164 */           ordinal = (Integer)ordinalMap.get((this.locals[l]).type);
...
/*     */ 
/*     */     
/*     */     public String toString() { return String.format("Local[ordinal=%d, name=%s, type=%s]", new Object[] { Integer.valueOf(this.ord), this.name, this.type }); }
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 238 */   public boolean isArgsOnly() { return this.argsOnly; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/* 245 */   public int getOrdinal() { return this.ordinal; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/* 252 */   public int getIndex() { return this.index; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/* 259 */   public Set<String> getNames() { return this.names; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/* 266 */   public boolean hasNames() { return !this.names.isEmpty(); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/* 273 */   public boolean printLVT() { return this.print; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 286 */   protected boolean isImplicit(Context context) { return (this.ordinal < 0 && this.index < context.baseArgIndex && this.names.isEmpty()); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 392 */     List<String> namesList = (List)Annotations.getValue(annotation, "name", (List)null);
...
/* Location:              D:\工程开发\Cracked\phosphor-1.12.2-0.2.6+build50-universal.jar!\org\spongepowered\asm\mixin\injection\modify\LocalVariableDiscriminator.class
