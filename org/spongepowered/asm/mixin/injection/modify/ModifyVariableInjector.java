...
/*     */ 
/*     */     
/*  66 */     public Context(Type returnType, boolean argsOnly, Target target, AbstractInsnNode node) { super(returnType, argsOnly, target, node); }
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */     
/*  79 */     ContextualInjectionPoint(IMixinContext context) { this.context = context; }
/*     */ 
/*     */ 
/*     */ 
/*     */     
/*  84 */     public boolean find(String desc, InsnList insns, Collection<AbstractInsnNode> nodes) { throw new InvalidInjectionException(this.context, getAtCode() + " injection point must be used in conjunction with @ModifyVariable"); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 206 */       context.insns.add(new VarInsnNode(25, 0));
/*     */     }
/*     */     
/* 209 */     context.insns.add(new VarInsnNode(this.returnType.getOpcode(21), local));
/* 210 */     invokeHandler(context.insns);
/* 211 */     context.insns.add(new VarInsnNode(this.returnType.getOpcode(54), local));
/*     */   }
/*     */ }


/* Location:              D:\工程开发\Cracked\phosphor-1.12.2-0.2.6+build50-universal.jar!\org\spongepowered\asm\mixin\injection\modify\ModifyVariableInjector.class
