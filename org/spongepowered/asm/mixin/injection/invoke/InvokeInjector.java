...
/*     */ 
/*     */   
/*  75 */   protected void checkTarget(Target target) { checkTargetModifiers(target, true); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 108 */       int superCallIndex = target.indexOf(superCall);
...
/*     */ 
/*     */   
/* 150 */   protected AbstractInsnNode invokeHandlerWithArgs(Type[] args, InsnList insns, int[] argMap) { return invokeHandlerWithArgs(args, insns, argMap, 0, args.length); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 163 */       insns.add(new VarInsnNode(25, 0));
/*     */     }
...
/* 196 */       insns.add(new VarInsnNode(args[arg].getOpcode(54), argMap[arg]));
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 210 */       insns.add(new VarInsnNode(args[arg].getOpcode(21), argMap[arg])); 
/*     */   }
/*     */ }


/* Location:              D:\工程开发\Cracked\phosphor-1.12.2-0.2.6+build50-universal.jar!\org\spongepowered\asm\mixin\injection\invoke\InvokeInjector.class
