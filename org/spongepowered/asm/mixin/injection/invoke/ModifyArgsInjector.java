...
/*     */ 
/*     */   
/*  63 */   protected void checkTarget(Target target) { checkTargetModifiers(target, false); }
/*     */ 
/*     */ 
/*     */   
...
/*     */     
/* 101 */     target.insns.insertBefore(targetMethod, insns);
/*     */   }
/*     */   
...
/* 122 */     insns.add(new MethodInsnNode(184, clArgs, "of", factoryDesc, false));
/* 123 */     insns.add(new InsnNode(89));
/*     */     
/* 125 */     if (!this.isStatic) {
/* 126 */       insns.add(new VarInsnNode(25, 0));
/* 127 */       insns.add(new InsnNode(95));
/*     */     } 
/*     */   }
/*     */   
...
/* 134 */         insns.add(new InsnNode(89));
/*     */       }
/* 136 */       insns.add(new MethodInsnNode(182, clArgs, "$" + i, "()" + args[i].getDescriptor(), false));
/* 137 */       if (i < args.length - 1)
/* 138 */         if (args[i].getSize() == 1) {
/* 139 */           insns.add(new InsnNode(95));
/*     */         } else {
/* 141 */           insns.add(new InsnNode(93));
/* 142 */           insns.add(new InsnNode(88));
/*     */         }  
/*     */     } 
/*     */   }
/*     */ }
...
/* Location:              D:\工程开发\Cracked\phosphor-1.12.2-0.2.6+build50-universal.jar!\org\spongepowered\asm\mixin\injection\invoke\ModifyArgsInjector.class
