...
/*     */   
/*  63 */   public ModifyConstantInjector(InjectionInfo info) { super(info, "@ModifyConstant"); }
/*     */ 
/*     */ 
/*     */   
...
/* 107 */     insns.add(new InsnNode(3));
/* 108 */     AbstractInsnNode invoke = invokeConstantHandler(Type.getType("I"), target, insns, insns);
/* 109 */     insns.add(new JumpInsnNode(opcode + 6, jumpNode.label));
/* 110 */     target.replaceNode(jumpNode, invoke, insns);
...
/* 132 */       before.insert(new VarInsnNode(25, 0));
...
/* Location:              D:\工程开发\Cracked\phosphor-1.12.2-0.2.6+build50-universal.jar!\org\spongepowered\asm\mixin\injection\invoke\ModifyConstantInjector.class
