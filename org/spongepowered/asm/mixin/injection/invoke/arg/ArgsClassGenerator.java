...
/*     */ 
/*     */   
/*  95 */   private final BiMap<String, String> classNames = HashBiMap.create();
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 103 */   private final Map<String, byte[]> classBytes = new HashMap();
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 134 */   public String getClassRef(String desc) { return getClassName(desc).replace('.', '/'); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 143 */   public byte[] generate(String name) { return getBytes(name); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 154 */     byte[] bytes = (byte[])this.classBytes.get(name);
/* 155 */     if (bytes == null) {
...
/* 178 */     CheckClassAdapter checkClassAdapter = writer;
/* 179 */     if (MixinEnvironment.getCurrentEnvironment().getOption(MixinEnvironment.Option.DEBUG_VERIFY)) {
/* 180 */       checkClassAdapter = new CheckClassAdapter(writer);
/*     */     }
/*     */     
...
/*     */     
/* 186 */     generateCtor(ref, desc, args, checkClassAdapter);
/* 187 */     generateToString(ref, desc, args, checkClassAdapter);
/* 188 */     generateFactory(ref, desc, args, checkClassAdapter);
/* 189 */     generateSetters(ref, desc, args, checkClassAdapter);
/* 190 */     generateGetters(ref, desc, args, checkClassAdapter);
/*     */     
...
/*     */     
/*     */     byte index;
/* 357 */     for (index = 0; index < args.length; index = (byte)(index + 1)) {
/* 358 */       set.visitVarInsn(21, 1);
/* 359 */       set.visitConstant(index);
/* 360 */       set.visitJumpInsn(159, labels[index]);
/*     */     } 
/*     */ 
/*     */     
...
/*     */ 
/*     */   
/* 530 */   private static String getSignature(Type[] args) { return (new SignaturePrinter("", null, args)).setFullyQualified(true).getFormattedArgs(); }
/*     */ }


/* Location:              D:\工程开发\Cracked\phosphor-1.12.2-0.2.6+build50-universal.jar!\org\spongepowered\asm\mixin\injection\invoke\arg\ArgsClassGenerator.class
