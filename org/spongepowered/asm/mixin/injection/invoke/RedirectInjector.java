...
/*     */ 
/*     */     
/* 117 */     RedirectInjector getOwner() { return RedirectInjector.this; }
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 146 */       this.captureTargetArgs = false;
/*     */ 
/*     */       
...
/* 153 */       this
/*     */         
/* 155 */         .locals = (node.getOpcode() == 184) ? this.args : (Type[])ObjectArrays.concat(Type.getType("L" + node.owner + ";"), this.args);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
/*     */   
/* 161 */   private Map<BeforeNew, ConstructorRedirectData> ctorRedirectors = new HashMap();
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/* 167 */   public RedirectInjector(InjectionInfo info) { this(info, "@Redirect"); }
/*     */ 
/*     */   
...
/* 174 */     boolean isFinal = (Annotations.getVisible(this.methodNode, org.spongepowered.asm.mixin.Final.class) != null);
...
/* 233 */     ConstructorRedirectData ctorRedirect = (ConstructorRedirectData)this.ctorRedirectors.get(ip);
...
/* 317 */     target.replaceNode(invoke.node, insn, insns);
...
/*     */       } 
/*     */       
/* 362 */       AnnotationNode coerce = Annotations.getInvisibleParameter(this.methodNode, org.spongepowered.asm.mixin.injection.Coerce.class, index);
/*     */       
...
/* 470 */       target.insns.insertBefore(fieldNode, new VarInsnNode(25, 0));
...
/*     */     } 
/*     */     
/* 502 */     target.replaceNode(fieldNode, invoke, insns);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 516 */       insns.add(new VarInsnNode(25, 0));
/* 517 */       if (!staticField) {
/* 518 */         insns.add(new InsnNode(95));
/*     */       }
/*     */     } 
/*     */     
/* 522 */     if (withArgs) {
...
/* 542 */       if (staticField) {
/* 543 */         insns.add(new VarInsnNode(25, 0));
/* 544 */         insns.add(new InsnNode(95));
/*     */       } else {
/* 546 */         int marshallVar = target.allocateLocals(fieldType.getSize());
/* 547 */         insns.add(new VarInsnNode(fieldType.getOpcode(54), marshallVar));
/* 548 */         insns.add(new VarInsnNode(25, 0));
/* 549 */         insns.add(new InsnNode(95));
/* 550 */         insns.add(new VarInsnNode(fieldType.getOpcode(21), marshallVar));
/*     */       } 
/*     */     }
/*     */     
/* 554 */     if (withArgs) {
...
/* 579 */     String alternateDesc = String.format("%s%s%s", new Object[] { desc.substring(0, pos), Joiner.on("").join(target.arguments), desc.substring(pos) });
...
/* 598 */     AbstractInsnNode dupNode = target.get(target.indexOf(newNode) + 1);
...
/* 626 */       target.removeNode(newNode);
/*     */     } else {
/* 628 */       target.replaceNode(newNode, new VarInsnNode(25, 0));
/*     */     } 
/*     */     
...
/* 644 */       insns.add(new InsnNode(89));
/* 645 */       insns.add(new JumpInsnNode(199, nullCheckSucceeded));
...
/* 647 */               .replace('/', '.') }));
/* 648 */       insns.add(nullCheckSucceeded);
/* 649 */       target.addToStack(1);
/*     */     } else {
/*     */       
/* 652 */       insns.add(new InsnNode(87));
/*     */     } 
/*     */     
/* 655 */     target.replaceNode(initNode, insns);
/* 656 */     meta.injected++;
/*     */   }
/*     */   
...
/* Location:              D:\工程开发\Cracked\phosphor-1.12.2-0.2.6+build50-universal.jar!\org\spongepowered\asm\mixin\injection\invoke\RedirectInjector.class
