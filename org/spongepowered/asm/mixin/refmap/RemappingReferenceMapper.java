...
/*     */ 
/*     */   
/*  93 */   private static final Map<String, Map<String, String>> srgs = new HashMap();
/*     */ 
/*     */ 
/*     */   
...
/*     */ 
/*     */   
/* 126 */   public boolean isDefault() { return this.refMap.isDefault(); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 135 */   public String getResourceName() { return this.refMap.getResourceName(); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 143 */   public String getStatus() { return this.refMap.getStatus(); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 151 */   public String getContext() { return this.refMap.getContext(); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 170 */     String remapped = (String)classCache.get(reference);
...
/* 174 */         remapped = remapped.replace((CharSequence)entry.getKey(), (CharSequence)entry.getValue());
/*     */       }
...
/* 182 */     Map<String, String> classCache = (Map)this.cache.get(className);
...
/*     */ 
/*     */   
/* 197 */   public String remapWithContext(String context, String className, String reference) { return this.refMap.remapWithContext(context, className, reference); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 210 */       return (Map)srgs.get(fileName);
/*     */     }
/*     */     
...
/* Location:              D:\工程开发\Cracked\phosphor-1.12.2-0.2.6+build50-universal.jar!\org\spongepowered\asm\mixin\refmap\RemappingReferenceMapper.class
