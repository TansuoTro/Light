...
/* 73 */       method.instructions.add(new VarInsnNode(25, 0));
/*    */     }
...
/* 78 */     method.instructions.add(new MethodInsnNode(opcode, (this.info.getClassNode()).name, this.targetMethod.name, this.targetMethod.desc, false));
/* 79 */     method.instructions.add(new InsnNode(this.returnType.getOpcode(172)));
/* 80 */     return method;
/*    */   }
/*    */ }


/* Location:              D:\工程开发\Cracked\phosphor-1.12.2-0.2.6+build50-universal.jar!\org\spongepowered\asm\mixin\gen\AccessorGeneratorMethodProxy.class
