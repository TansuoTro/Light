...
/*  87 */   private static final Set<String> loadedCoreMods = new HashSet();
...
/*     */ 
/*     */   
/* 191 */   private boolean isIgnoredReparseable() { return this.container.toString().contains("deobfedDeps"); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */       
/* 203 */       List<String> reparsedCoremods = (List)mdGetReparsedCoremods.invoke(null, new Object[0]);
...
/* 225 */     Method mdLoadCoreMod = this.clCoreModManager.getDeclaredMethod(GlobalProperties.getString("mixin.launch.fml.loadcoremodmethod", "loadCoreMod"), new Class[] { net.minecraft.launchwrapper.LaunchClassLoader.class, String.class, java.io.File.class });
/*     */     
...
/*     */     
/*     */     try {
/* 250 */       List<ITweaker> tweakers = (List)GlobalProperties.get("Tweaks");
/* 251 */       if (tweakers == null) {
/* 252 */         return false;
/*     */       }
/*     */       
/* 255 */       for (ITweaker tweaker : tweakers) {
/* 256 */         Class<? extends ITweaker> tweakClass = tweaker.getClass();
...
/*     */ 
/*     */   
/* 275 */   public String getPhaseProvider() { return MixinPlatformAgentFML.class.getName() + "$PhaseProvider"; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 283 */   public void prepare() { this.initInjectionState |= isTweakerQueued("FMLInjectionAndSortingTweaker"); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 301 */       Class<?> clFmlRemapperAdapter = Class.forName("org.spongepowered.asm.bridge.RemapperAdapterFML", true, Launch.classLoader);
...
/*     */ 
/*     */   
/* 326 */   public String getLaunchTarget() { return null; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 360 */     for (String tweaker : (List)GlobalProperties.get("TweakClasses")) {
...
/*     */     } 
/*     */     
/* 398 */     return (List)mdGetIgnoredMods.invoke(null, new Object[0]);
/*     */   }
/*     */ }


/* Location:              D:\工程开发\Cracked\phosphor-1.12.2-0.2.6+build50-universal.jar!\org\spongepowered\asm\launch\platform\MixinPlatformAgentFML.class
