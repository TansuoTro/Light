...
/*     */   
/*     */   @Deprecated
/*  92 */   public static void addProxy() { MixinService.getService().beginPhase(); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*  99 */     if (platform == null) {
/* 100 */       globalPlatformManager = GlobalProperties.get("mixin.platform");
...
/*     */       
/* 140 */       command = System.getProperty("sun.java.command");
...
/*     */ 
/*     */   
/* 189 */   static void inject() { getPlatform().inject(); }
/*     */ 
/*     */ 
/*     */   
/* 193 */   private static boolean isSubsystemRegistered() { return (GlobalProperties.get("mixin.initialised") != null); }
/*     */ 
/*     */ 
/*     */   
/* 197 */   private static boolean checkSubsystemVersion() { return "0.7.11".equals(getActiveSubsystemVersion()); }
/*     */ 
/*     */   
/*     */   private static Object getActiveSubsystemVersion() {
/* 201 */     version = GlobalProperties.get("mixin.initialised");
/* 202 */     return (version != null) ? version : "";
/*     */   }
/*     */ 
/*     */   
/* 206 */   private static void registerSubsystem(String version) { GlobalProperties.put("mixin.initialised", version); }
/*     */ }


/* Location:              D:\工程开发\Cracked\phosphor-1.12.2-0.2.6+build50-universal.jar!\org\spongepowered\asm\launch\MixinBootstrap.class
