...
/*     */ 
/*     */   
/*  99 */   public String getName() { return "LaunchWrapper"; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 122 */   public void prepare() { Launch.classLoader.addClassLoaderExclusion("org.spongepowered.asm.launch."); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */     }
/*     */     
/* 145 */     List<String> tweakClasses = (List)GlobalProperties.get("TweakClasses");
...
/*     */ 
/*     */   
/* 156 */   public ReEntranceLock getReEntranceLock() { return this.lock; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 164 */   public Collection<String> getPlatformAgents() { return ImmutableList.of("org.spongepowered.asm.launch.platform.MixinPlatformAgentFML"); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 174 */   public IClassProvider getClassProvider() { return this; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 182 */   public IClassBytecodeProvider getBytecodeProvider() { return this; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 191 */   public Class<?> findClass(String name) throws ClassNotFoundException { return Launch.classLoader.findClass(name); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 200 */   public Class<?> findClass(String name, boolean initialize) throws ClassNotFoundException { return Class.forName(name, initialize, Launch.classLoader); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 209 */   public Class<?> findAgentClass(String name, boolean initialize) throws ClassNotFoundException { return Class.forName(name, initialize, Launch.class.getClassLoader()); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 217 */   public void beginPhase() { Launch.classLoader.registerTransformer("org.spongepowered.asm.mixin.transformer.Proxy"); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 237 */   public InputStream getResourceAsStream(String name) { return Launch.classLoader.getResourceAsStream(name); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 246 */   public void registerInvalidClass(String className) { this.classLoaderUtil.registerInvalidClass(className); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 255 */   public boolean isClassLoaded(String className) { return this.classLoaderUtil.isClassLoaded(className); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 279 */   public URL[] getClassPath() { return (URL[])Launch.classLoader.getSources().toArray(new URL[0]); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 432 */   public ClassNode getClassNode(String className) throws ClassNotFoundException, IOException { return getClassNode(getClassBytes(className, true), 0); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 445 */     classReader.accept(classNode, flags);
...
/* 456 */     for (ITweaker tweaker : (List)GlobalProperties.get("Tweaks")) {
...
/*     */     try {
/* 484 */       Class<?> clazz = Class.forName(className, false, Launch.classLoader);
...
/* Location:              D:\工程开发\Cracked\phosphor-1.12.2-0.2.6+build50-universal.jar!\org\spongepowered\asm\service\mojang\MixinServiceLaunchWrapper.class
