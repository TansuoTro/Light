...
/*  65 */     this.cachedClasses = (Map)getField(classLoader, "cachedClasses");
/*  66 */     this.invalidClasses = (Set)getField(classLoader, "invalidClasses");
/*  67 */     this.classLoaderExceptions = (Set)getField(classLoader, "classLoaderExceptions");
/*  68 */     this.transformerExceptions = (Set)getField(classLoader, "transformerExceptions");
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*  75 */   LaunchClassLoader getClassLoader() { return this.classLoader; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/*  86 */   boolean isClassLoaded(String name) { return this.cachedClasses.containsKey(name); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/*  98 */   boolean isClassExcluded(String name, String transformedName) { return (isClassClassLoaderExcluded(name, transformedName) || isClassTransformerExcluded(name, transformedName)); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              D:\工程开发\Cracked\phosphor-1.12.2-0.2.6+build50-universal.jar!\org\spongepowered\asm\service\mojang\LaunchClassLoaderUtil.class
