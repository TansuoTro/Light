...
/*     */   
/*  54 */   public SignatureReader(String signature) { this.signature = signature; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 130 */   public void acceptType(SignatureVisitor v) { parseType(this.signature, 0, v); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */         case ';':
/* 180 */           if (!visited) {
/* 181 */             String name = signature.substring(start, pos - 1);
/* 182 */             if (inner) {
/* 183 */               v.visitInnerClassType(name);
/*     */             } else {
/* 185 */               v.visitClassType(name);
/*     */             } 
/*     */           } 
/* 188 */           if (c == ';') {
/* 189 */             v.visitEnd();
...
/* Location:              D:\工程开发\Cracked\phosphor-1.12.2-0.2.6+build50-universal.jar!\org\spongepowered\asm\lib\signature\SignatureReader.class
