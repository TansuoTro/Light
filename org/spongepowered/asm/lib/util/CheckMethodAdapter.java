...
/*      */   
/*      */   static  {
/*  148 */     s = "BBBBBBBBBBBBBBBBCCIAADDDDDAAAAAAAAAAAAAAAAAAAABBBBBBBBDDDDDAAAAAAAAAAAAAAAAAAAABBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBJBBBBBBBBBBBBBBBBBBBBHHHHHHHHHHHHHHHHDKLBBBBBBFFFFGGGGAECEBBEEBBAMHHAA";
/*      */ 
/*      */ 
/*      */     
/*  152 */     TYPE = new int[s.length()];
/*  153 */     for (int i = 0; i < TYPE.length; i++) {
/*  154 */       TYPE[i] = s.charAt(i) - 'A' - '\001';
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/*  381 */   public CheckMethodAdapter(MethodVisitor mv) { this(mv, new HashMap()); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  423 */     this.usedLabels = new HashSet();
/*  424 */     this.handlers = new ArrayList();
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  447 */     this(new MethodNode(327680, access, name, desc, null, null)
/*      */         {
/*      */           public void visitEnd() {
/*  450 */             Analyzer<BasicValue> a = new Analyzer<BasicValue>(new BasicVerifier());
/*      */             
/*      */             try {
...
/*      */     int mStack, mStack, mStack, mStack, mLocal, mLocal, mLocal, mLocal;
...
/*      */     }
/*      */     
/*  823 */     for (int i = 0; i < labels.length; i++) {
...
/*  828 */     for (int i = 0; i < labels.length; i++) {
...
/* 1017 */       Integer start = (Integer)this.labels.get(this.handlers.get(i++));
/* 1018 */       Integer end = (Integer)this.labels.get(this.handlers.get(i++));
...
/*      */ 
/*      */   
/* 1232 */   static void checkIdentifier(String name, String msg) { checkIdentifier(name, 0, -1, msg); }
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/* 1285 */       for (int i = 0; i < name.length(); i++) {
/* 1286 */         if (".;[/<>".indexOf(name.charAt(i)) != -1) {
...
/* 1354 */           slash = max;
/*      */         }
/* 1356 */         checkIdentifier(name, begin, slash, null);
/* 1357 */         begin = slash + 1;
...
/*      */         
/*      */         try {
/* 1436 */           checkInternalName(desc, start + 1, index, null);
...
/* Location:              D:\工程开发\Cracked\phosphor-1.12.2-0.2.6+build50-universal.jar!\org\spongepowered\asm\li\\util\CheckMethodAdapter.class
