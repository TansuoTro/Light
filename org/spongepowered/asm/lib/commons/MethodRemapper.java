...
/*     */   
/*  50 */   public MethodRemapper(MethodVisitor mv, Remapper remapper) { this(327680, mv, remapper); }
/*     */ 
/*     */ 
/*     */   
...
/*     */ 
/*     */   
/*  91 */   public void visitFrame(int type, int nLocal, Object[] local, int nStack, Object[] stack) { super.visitFrame(type, nLocal, remapEntries(nLocal, local), nStack, 
...
/*     */ 
/*     */   
/* 172 */   public void visitTypeInsn(int opcode, String type) { super.visitTypeInsn(opcode, this.remapper.mapType(type)); }
/*     */ 
/*     */ 
/*     */ 
/*     */   
/* 177 */   public void visitLdcInsn(Object cst) { super.visitLdcInsn(this.remapper.mapValue(cst)); }
/*     */ 
/*     */ 
/*     */ 
/*     */   
/* 182 */   public void visitMultiANewArrayInsn(String desc, int dims) { super.visitMultiANewArrayInsn(this.remapper.mapDesc(desc), dims); }
/*     */ 
/*     */ 
/*     */ 
/*     */   
...
/*     */ 
/*     */   
/* 196 */   public void visitTryCatchBlock(Label start, Label end, Label handler, String type) { super.visitTryCatchBlock(start, end, handler, (type == null) ? null : this.remapper
/* 197 */         .mapType(type)); }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              D:\工程开发\Cracked\phosphor-1.12.2-0.2.6+build50-universal.jar!\org\spongepowered\asm\lib\commons\MethodRemapper.class
