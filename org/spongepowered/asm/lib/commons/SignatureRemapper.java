...
/*  49 */   private Stack<String> classNames = new Stack();
/*     */ 
/*     */   
/*  52 */   public SignatureRemapper(SignatureVisitor v, Remapper remapper) { this(327680, v, remapper); }
/*     */ 
/*     */ 
/*     */   
...
/*  70 */     String outerClassName = (String)this.classNames.pop();
...
/*     */ 
/*     */   
/*  82 */   public void visitFormalTypeParameter(String name) { this.v.visitFormalTypeParameter(name); }
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*  87 */   public void visitTypeVariable(String name) { this.v.visitTypeVariable(name); }
/*     */ 
/*     */ 
/*     */   
...
/*     */ 
/*     */   
/*  98 */   public void visitBaseType(char descriptor) { this.v.visitBaseType(descriptor); }
/*     */ 
/*     */ 
/*     */   
...
/*     */ 
/*     */   
/* 145 */   public void visitTypeArgument() { this.v.visitTypeArgument(); }
/*     */ 
/*     */ 
/*     */   
...
/* Location:              D:\工程开发\Cracked\phosphor-1.12.2-0.2.6+build50-universal.jar!\org\spongepowered\asm\lib\commons\SignatureRemapper.class
