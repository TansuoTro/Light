...
/*      */         }
/* 1067 */         this.code.putByte((opcode <= 166) ? ((opcode + 1 ^ true) - 1) : (opcode ^ true));
/*      */         
...
/* Location:              D:\工程开发\Cracked\phosphor-1.12.2-0.2.6+build50-universal.jar!\org\spongepowered\asm\lib\MethodWriter.class
