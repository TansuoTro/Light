...
/*     */       
/* 383 */       if (source >= 0) {
/* 384 */         int offset = position - source;
/* 385 */         if (offset < -32768 || offset > 32767) {
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 406 */         data[reference] = (byte)offset; continue;
/*     */       } 
...
/*     */ 
/*     */   
/* 427 */   Label getFirst() { return (this.frame == null) ? this : this.frame.owner; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 443 */       return ((this.srcAndRefPositions[(int)(id >>> 32)] & (int)id) != 0);
/*     */     }
/* 445 */     return false;
/*     */   }
/*     */ 
...
/*     */     } 
/* 482 */     this.srcAndRefPositions[(int)(id >>> 32)] = this.srcAndRefPositions[(int)(id >>> 32)] | (int)id;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 562 */   public String toString() { return "L" + System.identityHashCode(this); }
/*     */ }


/* Location:              D:\工程开发\Cracked\phosphor-1.12.2-0.2.6+build50-universal.jar!\org\spongepowered\asm\lib\Label.class
