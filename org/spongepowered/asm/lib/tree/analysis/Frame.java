...
/*  88 */     this.values = (Value[])new Value[nLocals + nStack];
...
/*     */ 
/*     */   
/* 125 */   public void setReturn(V v) { this.returnValue = v; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 134 */   public int getLocals() { return this.locals; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 143 */   public int getMaxStackSize() { return this.values.length - this.locals; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 189 */   public int getStackSize() { return this.top; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 202 */   public V getStack(int i) throws IndexOutOfBoundsException { return (V)this.values[i + this.locals]; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/* 209 */   public void clearStack() { this.top = 0; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */     }
/*     */     
/* 224 */     return (V)this.values[--this.top + this.locals];
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     }
/*     */     
/* 240 */     this.values[this.top++ + this.locals] = value; } public void execute(AbstractInsnNode insn, Interpreter<V> interpreter) throws AnalyzerException { int i; int i; List<V> values; List<V> values; List<V> values; V value3; String desc; int i; String desc; int var; int var; V value1; V value1; V value1; V value1; V value1; V value1; V value1; V value1; V value1; V value1; V value1; V value1; V value1; V value1; V value1; V value1; V value2;
/*     */     V value2;
/*     */     V value2;
/*     */     V value2;
/*     */     V value2;
...
/*     */       case 57:
/*     */       case 58:
/* 297 */         value1 = (V)interpreter.copyOperation(insn, pop());
...
/*     */ 
/*     */               
/* 415 */               throw new AnalyzerException(insn, "Illegal use of DUP2_X1"); }  } else { throw new AnalyzerException(insn, "Illegal use of DUP2_X1"); }  } else { V value2 = (V)pop(); if (value2.getSize() == 1) { push(interpreter.copyOperation(insn, value1)); push(value2); push(value1); } else { throw new AnalyzerException(insn, "Illegal use of DUP2_X1"); }  } 
/*     */       case 94:
/* 417 */         value1 = (V)pop();
...
/* 611 */         for (i = Type.getArgumentTypes(desc).length; i > 0; i--) {
...
/* 627 */         for (i = Type.getArgumentTypes(desc).length; i > 0; i--) {
...
/* 691 */       V v = (V)interpreter.merge(this.values[i], frame.values[i]);
...
/* Location:              D:\工程开发\Cracked\phosphor-1.12.2-0.2.6+build50-universal.jar!\org\spongepowered\asm\lib\tree\analysis\Frame.class
