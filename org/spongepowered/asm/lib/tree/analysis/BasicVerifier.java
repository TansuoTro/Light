...
/*     */ {
/*  50 */   public BasicVerifier() { super(327680); }
/*     */ 
/*     */ 
/*     */   
/*  54 */   protected BasicVerifier(int api) { super(api); }
/*     */   
...
/*     */     }
/*  97 */     return value;
/*     */   } public BasicValue unaryOperation(AbstractInsnNode insn, BasicValue value) throws AnalyzerException { BasicValue expected;
/*     */     BasicValue expected;
/*     */     BasicValue expected;
/*     */     BasicValue expected;
/*     */     BasicValue expected;
...
/*     */     }
/* 184 */     return super.unaryOperation(insn, value); } public BasicValue binaryOperation(AbstractInsnNode insn, BasicValue value1, BasicValue value2) throws AnalyzerException { FieldInsnNode fin; BasicValue expected2; BasicValue expected2; BasicValue expected2; BasicValue expected2; BasicValue expected2; BasicValue expected2; BasicValue expected2; BasicValue expected2; BasicValue expected2; BasicValue expected2; BasicValue expected2; BasicValue expected2; BasicValue expected2; BasicValue expected2; BasicValue expected2; BasicValue expected1; BasicValue expected1; BasicValue expected1; BasicValue expected1; BasicValue expected1; BasicValue expected1;
/*     */     BasicValue expected1;
/*     */     BasicValue expected1;
/*     */     BasicValue expected1;
/*     */     BasicValue expected1;
...
/* 200 */           BasicValue expected1 = newValue(Type.getType("[Z"));
/*     */         } else {
/* 202 */           BasicValue expected1 = newValue(Type.getType("[B"));
/*     */         } 
...
/*     */     }
/* 311 */     return super.binaryOperation(insn, value1, value2); } public BasicValue ternaryOperation(AbstractInsnNode insn, BasicValue value1, BasicValue value2, BasicValue value3) throws AnalyzerException { BasicValue expected3; BasicValue expected3; BasicValue expected3; BasicValue expected3; BasicValue expected3; BasicValue expected3;
...
/* 328 */           BasicValue expected1 = newValue(Type.getType("[Z"));
/*     */         } else {
/* 330 */           BasicValue expected1 = newValue(Type.getType("[B"));
/*     */         } 
...
/* 390 */         if (!isSubTypeOf((BasicValue)values.get(i++), newValue(owner))) {
...
/* 400 */         BasicValue encountered = (BasicValue)values.get(i++);
...
/*     */ 
/*     */   
/* 421 */   protected boolean isArrayValue(BasicValue value) { return value.isReference(); }
/*     */ 
/*     */ 
/*     */ 
/*     */   
/* 426 */   protected BasicValue getElementValue(BasicValue objectArrayValue) throws AnalyzerException { return BasicValue.REFERENCE_VALUE; }
/*     */ 
/*     */ 
/*     */ 
/*     */   
/* 431 */   protected boolean isSubTypeOf(BasicValue value, BasicValue expected) { return value.equals(expected); }
/*     */ }


/* Location:              D:\工程开发\Cracked\phosphor-1.12.2-0.2.6+build50-universal.jar!\org\spongepowered\asm\lib\tree\analysis\BasicVerifier.class
