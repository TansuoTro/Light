...
/* 299 */     this.exceptions = new ArrayList((exceptions == null) ? 0 : exceptions.length);
/*     */     
/* 301 */     boolean isAbstract = ((access & 0x400) != 0);
/* 302 */     if (!isAbstract) {
/* 303 */       this.localVariables = new ArrayList(5);
/*     */     }
/* 305 */     this.tryCatchBlocks = new ArrayList();
...
/* 319 */       this.parameters = new ArrayList(5);
/*     */     }
...
/* 327 */     return new AnnotationNode(new ArrayList<Object>(this, 0)
/*     */         {
...
/* 342 */         this.visibleAnnotations = new ArrayList(1);
/*     */       }
/* 344 */       this.visibleAnnotations.add(an);
/*     */     } else {
/* 346 */       if (this.invisibleAnnotations == null) {
/* 347 */         this.invisibleAnnotations = new ArrayList(1);
/*     */       }
...
/* 360 */         this.visibleTypeAnnotations = new ArrayList(1);
/*     */       }
/* 362 */       this.visibleTypeAnnotations.add(an);
/*     */     } else {
/* 364 */       if (this.invisibleTypeAnnotations == null) {
/* 365 */         this.invisibleTypeAnnotations = new ArrayList(1);
/*     */       }
...
/* 380 */         this.visibleParameterAnnotations = (List[])new List[params];
/*     */       } 
/* 382 */       if (this.visibleParameterAnnotations[parameter] == null) {
/* 383 */         this.visibleParameterAnnotations[parameter] = new ArrayList(1);
/*     */       }
/*     */       
...
/* 390 */         this.invisibleParameterAnnotations = (List[])new List[params];
/*     */       } 
/* 392 */       if (this.invisibleParameterAnnotations[parameter] == null) {
/* 393 */         this.invisibleParameterAnnotations[parameter] = new ArrayList(1);
/*     */       }
/*     */       
...
/* 404 */       this.attrs = new ArrayList(1);
/*     */     }
...
/*     */ 
/*     */   
/* 423 */   public void visitInsn(int opcode) { this.instructions.add(new InsnNode(opcode)); }
/*     */ 
/*     */ 
/*     */ 
/*     */   
/* 428 */   public void visitIntInsn(int opcode, int operand) { this.instructions.add(new IntInsnNode(opcode, operand)); }
/*     */ 
/*     */ 
/*     */ 
/*     */   
/* 433 */   public void visitVarInsn(int opcode, int var) { this.instructions.add(new VarInsnNode(opcode, var)); }
/*     */ 
/*     */ 
/*     */ 
/*     */   
/* 438 */   public void visitTypeInsn(int opcode, String type) { this.instructions.add(new TypeInsnNode(opcode, type)); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/* 444 */   public void visitFieldInsn(int opcode, String owner, String name, String desc) { this.instructions.add(new FieldInsnNode(opcode, owner, name, desc)); }
/*     */ 
/*     */ 
/*     */ 
/*     */   
...
/*     */ 
/*     */   
/* 471 */   public void visitInvokeDynamicInsn(String name, String desc, Handle bsm, Object... bsmArgs) { this.instructions.add(new InvokeDynamicInsnNode(name, desc, bsm, bsmArgs)); }
/*     */ 
/*     */ 
/*     */ 
/*     */   
/* 476 */   public void visitJumpInsn(int opcode, Label label) { this.instructions.add(new JumpInsnNode(opcode, getLabelNode(label))); }
/*     */ 
/*     */ 
/*     */ 
/*     */   
/* 481 */   public void visitLabel(Label label) { this.instructions.add(getLabelNode(label)); }
/*     */ 
/*     */ 
/*     */ 
/*     */   
/* 486 */   public void visitLdcInsn(Object cst) { this.instructions.add(new LdcInsnNode(cst)); }
/*     */ 
/*     */ 
/*     */ 
/*     */   
/* 491 */   public void visitIincInsn(int var, int increment) { this.instructions.add(new IincInsnNode(var, increment)); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/* 497 */   public void visitTableSwitchInsn(int min, int max, Label dflt, Label... labels) { this.instructions.add(new TableSwitchInsnNode(min, max, getLabelNode(dflt), 
...
/*     */ 
/*     */   
/* 504 */   public void visitLookupSwitchInsn(Label dflt, int[] keys, Label[] labels) { this.instructions.add(new LookupSwitchInsnNode(getLabelNode(dflt), keys, 
/* 505 */           getLabelNodes(labels))); }
/*     */ 
/*     */ 
/*     */ 
/*     */   
/* 510 */   public void visitMultiANewArrayInsn(String desc, int dims) { this.instructions.add(new MultiANewArrayInsnNode(desc, dims)); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 526 */         insn.visibleTypeAnnotations = new ArrayList(1);
/*     */       }
/*     */       
/* 529 */       insn.visibleTypeAnnotations.add(an);
/*     */     } else {
/* 531 */       if (insn.invisibleTypeAnnotations == null) {
/* 532 */         insn.invisibleTypeAnnotations = new ArrayList(1);
/*     */       }
/*     */       
...
/* 585 */         this.visibleLocalVariableAnnotations = new ArrayList(1);
/*     */       }
/*     */       
/* 588 */       this.visibleLocalVariableAnnotations.add(an);
/*     */     } else {
/* 590 */       if (this.invisibleLocalVariableAnnotations == null) {
/* 591 */         this.invisibleLocalVariableAnnotations = new ArrayList(1);
/*     */       }
/*     */       
...
/*     */ 
/*     */   
/* 601 */   public void visitLineNumber(int line, Label start) { this.instructions.add(new LineNumberNode(line, getLabelNode(start))); }
/*     */ 
/*     */ 
/*     */   
...
/*     */       }
/* 675 */       int n = (this.tryCatchBlocks == null) ? 0 : this.tryCatchBlocks.size();
/* 676 */       for (int i = 0; i < n; i++) {
/* 677 */         TryCatchBlockNode tcb = (TryCatchBlockNode)this.tryCatchBlocks.get(i);
...
/*     */         }
/*     */       } 
/* 687 */       for (int i = 0; i < this.instructions.size(); i++) {
...
/* 741 */     for (i = 0; i < n; i++) {
/* 742 */       ParameterNode parameter = (ParameterNode)this.parameters.get(i);
...
/* 771 */     for (i = 0; i < n; i++) {
/* 772 */       TypeAnnotationNode an = (TypeAnnotationNode)this.invisibleTypeAnnotations.get(i);
...
/* 804 */     for (i = 0; i < n; i++) {
/* 805 */       mv.visitAttribute((Attribute)this.attrs.get(i));
/*     */     }
/*     */     
...
/* Location:              D:\工程开发\Cracked\phosphor-1.12.2-0.2.6+build50-universal.jar!\org\spongepowered\asm\lib\tree\MethodNode.class
