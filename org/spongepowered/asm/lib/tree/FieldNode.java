...
/* 197 */         this.visibleAnnotations = new ArrayList(1);
/*     */       }
/* 199 */       this.visibleAnnotations.add(an);
/*     */     } else {
/* 201 */       if (this.invisibleAnnotations == null) {
/* 202 */         this.invisibleAnnotations = new ArrayList(1);
/*     */       }
...
/* 215 */         this.visibleTypeAnnotations = new ArrayList(1);
/*     */       }
/* 217 */       this.visibleTypeAnnotations.add(an);
/*     */     } else {
/* 219 */       if (this.invisibleTypeAnnotations == null) {
/* 220 */         this.invisibleTypeAnnotations = new ArrayList(1);
/*     */       }
...
/* 230 */       this.attrs = new ArrayList(1);
/*     */     }
...
/* 296 */     for (i = 0; i < n; i++) {
/* 297 */       TypeAnnotationNode an = (TypeAnnotationNode)this.invisibleTypeAnnotations.get(i);
/* 298 */       an.accept(fv.visitTypeAnnotation(an.typeRef, an.typePath, an.desc, false));
/*     */     } 
/*     */     
/* 301 */     n = (this.attrs == null) ? 0 : this.attrs.size();
/* 302 */     for (i = 0; i < n; i++) {
/* 303 */       fv.visitAttribute((Attribute)this.attrs.get(i));
/*     */     }
/* 305 */     fv.visitEnd();
/*     */   }
/*     */ }
...
/* Location:              D:\工程开发\Cracked\phosphor-1.12.2-0.2.6+build50-universal.jar!\org\spongepowered\asm\lib\tree\FieldNode.class
