...
/*     */   
/*  70 */   public int size() { return this.size; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/*  80 */   public AbstractInsnNode getFirst() { return this.first; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/*  90 */   public AbstractInsnNode getLast() { return this.last; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 173 */   public ListIterator<AbstractInsnNode> iterator() { return iterator(0); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 186 */   public ListIterator<AbstractInsnNode> iterator(int index) { return new InsnListIterator(index); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 508 */   public void clear() { removeAll(false); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 537 */       if (index == this$0.size()) {
/* 538 */         this.next = null;
/* 539 */         this.prev = this$0.getLast();
/*     */       } else {
/* 541 */         this.next = this$0.get(index);
/* 542 */         this.prev = this.next.prev;
/*     */       } 
/*     */     }
/*     */ 
/*     */     
/* 547 */     public boolean hasNext() { return (this.next != null); }
/*     */ 
/*     */     
/*     */     public Object next() {
...
/*     */ 
/*     */     
/* 576 */     public boolean hasPrevious() { return (this.prev != null); }
/*     */ 
/*     */     
...
/* Location:              D:\工程开发\Cracked\phosphor-1.12.2-0.2.6+build50-universal.jar!\org\spongepowered\asm\lib\tree\InsnList.class
