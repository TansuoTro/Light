...
/*     */ 
/*     */   
/* 217 */   public static Type getType(String typeDescriptor) { return getType(typeDescriptor.toCharArray(), 0); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 241 */   public static Type getMethodType(String methodDescriptor) { return getType(methodDescriptor.toCharArray(), 0); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 257 */   public static Type getMethodType(Type returnType, Type... argumentTypes) { return getType(getMethodDescriptor(returnType, argumentTypes)); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 301 */   public static Type getType(Constructor<?> c) { return getType(getConstructorDescriptor(c)); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 312 */   public static Type getType(Method m) { return getType(getMethodDescriptor(m)); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 402 */   public static Type getReturnType(Method method) { return getType(method.getReturnType()); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 514 */   public int getSort() { return this.sort; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 538 */   public Type getElementType() { return getType(this.buf, this.off + getDimensions()); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 589 */   public String getInternalName() { return new String(this.buf, this.off, this.len); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 599 */   public Type[] getArgumentTypes() { return getArgumentTypes(getDescriptor()); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 609 */   public Type getReturnType() { return getReturnType(getDescriptor()); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 624 */   public int getArgumentsAndReturnSizes() { return getArgumentsAndReturnSizes(getDescriptor()); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 701 */   public static String getInternalName(Class<?> c) { return c.getName().replace('.', '/'); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 817 */   public int getSize() { return (this.buf == null) ? (this.off & 0xFF) : 1; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 903 */   public String toString() { return getDescriptor(); }
/*     */ }


/* Location:              D:\工程开发\Cracked\phosphor-1.12.2-0.2.6+build50-universal.jar!\org\spongepowered\asm\lib\Type.class
