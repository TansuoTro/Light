...
/*     */ 
/*     */   
/* 138 */   public static String getName(VariableElement field) { return (field != null) ? field.getSimpleName().toString() : null; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 148 */   public static String getName(ExecutableElement method) { return (method != null) ? method.getSimpleName().toString() : null; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 185 */   public static String getJavaSignature(String descriptor) { return (new SignaturePrinter("", descriptor)).setFullyQualified(true).toDescriptor(); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 385 */   private static TypeMirror toRawType(ProcessingEnvironment processingEnv, DeclaredType targetType) { return processingEnv.getElementUtils().getTypeElement(((TypeElement)targetType.asElement()).getQualifiedName()).asType(); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              D:\工程开发\Cracked\phosphor-1.12.2-0.2.6+build50-universal.jar!\org\spongepowered\tools\obfuscation\mirror\TypeUtils.class
