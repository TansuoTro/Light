...
/*     */ {
/*  56 */   public TargetValidator(IMixinAnnotationProcessor ap) { super(ap, IMixinValidator.ValidationPass.LATE); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*  84 */         boolean isAccessor = AnnotationHandle.of(element, org.spongepowered.asm.mixin.gen.Accessor.class).exists();
/*  85 */         boolean isInvoker = AnnotationHandle.of(element, org.spongepowered.asm.mixin.gen.Invoker.class).exists();
/*  86 */         containsNonAccessorMethod |= ((!isAccessor && !isInvoker));
/*     */       } 
/*     */     } 
/*     */     
/*  90 */     if (!containsNonAccessorMethod) {
/*     */       return;
/*     */     }
/*     */     
...
/* Location:              D:\工程开发\Cracked\phosphor-1.12.2-0.2.6+build50-universal.jar!\org\spongepowered\tools\obfuscation\validation\TargetValidator.class
