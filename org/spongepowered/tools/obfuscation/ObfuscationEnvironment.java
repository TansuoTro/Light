...
/*  97 */     this.remapper = new RemapperProxy();
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */     
/* 127 */     this.mappingProvider = getMappingProvider(this.ap, this.ap.getProcessingEnvironment().getFiler());
/* 128 */     this.mappingWriter = getMappingWriter(this.ap, this.ap.getProcessingEnvironment().getFiler());
/*     */   }
/*     */ 
/*     */ 
/*     */   
/* 133 */   public String toString() { return this.type.toString(); }
/*     */ 
/*     */   
...
/*     */ 
/*     */   
/* 178 */   public ObfuscationType getType() { return this.type; }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 213 */   public MappingMethod getObfMethod(MappingMethod method) { return getObfMethod(method, true); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 289 */   public String remapDescriptor(String desc) { return ObfuscationUtil.mapDescriptor(desc, this.remapper); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 297 */   public MappingField getObfField(MemberInfo field) { return getObfField(field.asFieldMapping(), true); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 305 */   public MappingField getObfField(MappingField field) { return getObfField(field, true); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 348 */     IMappingConsumer.MappingSet<MappingField> fields = new IMappingConsumer.MappingSet<MappingField>();
/* 349 */     IMappingConsumer.MappingSet<MappingMethod> methods = new IMappingConsumer.MappingSet<MappingMethod>();
/*     */     
/* 351 */     for (IMappingConsumer mappings : consumers) {
/* 352 */       fields.addAll(mappings.getFieldMappings(this.type));
/* 353 */       methods.addAll(mappings.getMethodMappings(this.type));
/*     */     } 
/*     */     
...
/* Location:              D:\工程开发\Cracked\phosphor-1.12.2-0.2.6+build50-universal.jar!\org\spongepowered\tools\obfuscation\ObfuscationEnvironment.class
