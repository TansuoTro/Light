...
/*  89 */   private static Map<ProcessingEnvironment, AnnotatedMixins> instances = new HashMap();
/*     */   
...
/* 104 */     this.mixins = new HashMap();
/*     */ 
/*     */ 
/*     */ 
/*     */     
/* 109 */     this.mixinsForPass = new ArrayList();
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */     
/* 124 */     this.tokenCache = new HashMap();
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 148 */     this.obf.init();
/*     */     
/* 150 */     this.validators = ImmutableList.of(new ParentValidator(this), new TargetValidator(this));
/*     */ 
/*     */ 
/*     */ 
/*     */     
...
/*     */ 
/*     */   
/* 188 */   public ITypeHandleProvider getTypeProvider() { return this; }
/*     */ 
/*     */ 
/*     */ 
/*     */   
/* 193 */   public ITokenProvider getTokenProvider() { return this; }
/*     */ 
/*     */ 
/*     */ 
/*     */   
/* 198 */   public IObfuscationManager getObfuscationManager() { return this.obf; }
/*     */ 
/*     */ 
/*     */ 
/*     */   
/* 203 */   public IJavadocProvider getJavadocProvider() { return this; }
/*     */ 
/*     */ 
/*     */ 
/*     */   
/* 208 */   public ProcessingEnvironment getProcessingEnvironment() { return this.processingEnv; }
/*     */ 
/*     */ 
/*     */ 
/*     */   
/* 213 */   public IMixinAnnotationProcessor.CompilerEnvironment getCompilerEnvironment() { return this.env; }
/*     */ 
/*     */ 
/*     */   
/*     */   public Integer getToken(String token) {
/* 218 */     if (this.tokenCache.containsKey(token)) {
/* 219 */       return (Integer)this.tokenCache.get(token);
/*     */     }
/*     */     
...
/*     */     }
/*     */     
/* 240 */     String value = (String)this.processingEnv.getOptions().get(option);
/* 241 */     if (value != null) {
/* 242 */       return value;
/*     */     }
/*     */     
...
/*     */ 
/*     */   
/* 280 */   public void writeMappings() { this.obf.writeMappings(); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/* 287 */   public void writeReferences() { this.obf.writeReferences(); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/* 294 */   public void clear() { this.mixins.clear(); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 316 */   public AnnotatedMixin getMixin(TypeElement mixinType) { return getMixin(mixinType.getQualifiedName().toString()); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */   
/* 323 */   public AnnotatedMixin getMixin(String mixinType) { return (AnnotatedMixin)this.mixins.get(mixinType); }
/*     */ 
/*     */ 
/*     */   
/* 327 */   public Collection<TypeMirror> getMixinsTargeting(TypeMirror targetType) { return getMixinsTargeting((TypeElement)((DeclaredType)targetType).asElement()); }
/*     */ 
/*     */   
...
/*     */       return;
/*     */     } 
/* 356 */     AnnotationHandle accessor = AnnotationHandle.of(method, org.spongepowered.asm.mixin.gen.Accessor.class);
...
/*     */       return;
/*     */     } 
/* 373 */     AnnotationHandle invoker = AnnotationHandle.of(method, org.spongepowered.asm.mixin.gen.Invoker.class);
...
/*     */       return;
/*     */     } 
/* 390 */     AnnotationHandle overwrite = AnnotationHandle.of(method, org.spongepowered.asm.mixin.Overwrite.class);
...
/* 445 */     remap.dispatchPendingMessages(this);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 471 */   public void onPassStarted() { this.mixinsForPass.clear(); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */     }
/*     */     
/* 482 */     for (AnnotatedMixin mixin : roundEnv.processingOver() ? this.mixins.values() : this.mixinsForPass) {
...
/*     */ 
/*     */   
/* 488 */   private boolean shouldRemap(AnnotatedMixin mixinClass, AnnotationHandle annotation) { return annotation.getBoolean("remap", mixinClass.remap()); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 506 */   public void printMessage(Diagnostic.Kind kind, CharSequence msg, Element element) { this.processingEnv.getMessager().printMessage(kind, msg, element); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 514 */   public void printMessage(Diagnostic.Kind kind, CharSequence msg, Element element, AnnotationMirror annotation) { this.processingEnv.getMessager().printMessage(kind, msg, element, annotation); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/*     */ 
/*     */   
/* 522 */   public void printMessage(Diagnostic.Kind kind, CharSequence msg, Element element, AnnotationMirror annotation, AnnotationValue value) { this.processingEnv.getMessager().printMessage(kind, msg, element, annotation, value); }
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 566 */         return new TypeHandleSimulated(packageElement, name, simulatedTarget);
/*     */       }
/*     */     } 
/*     */     
/* 570 */     return new TypeHandleSimulated(name, simulatedTarget);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 587 */     AnnotatedMixins mixins = (AnnotatedMixins)instances.get(processingEnv);
/* 588 */     if (mixins == null) {
...
/* Location:              D:\工程开发\Cracked\phosphor-1.12.2-0.2.6+build50-universal.jar!\org\spongepowered\tools\obfuscation\AnnotatedMixins.class
