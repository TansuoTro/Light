...
/*  99 */     for (Element elem : roundEnv.getElementsAnnotatedWith(org.spongepowered.asm.mixin.Shadow.class)) {
...
/*     */         continue;
/*     */       } 
/* 106 */       AnnotationHandle shadow = AnnotationHandle.of(elem, org.spongepowered.asm.mixin.Shadow.class);
/*     */       
...
/* 123 */     for (Element elem : roundEnv.getElementsAnnotatedWith(org.spongepowered.asm.mixin.Overwrite.class)) {
...
/* 143 */     for (Element elem : roundEnv.getElementsAnnotatedWith(org.spongepowered.asm.mixin.gen.Accessor.class)) {
...
/* 163 */     for (Element elem : roundEnv.getElementsAnnotatedWith(org.spongepowered.asm.mixin.gen.Invoker.class)) {
...
/* 183 */     for (Element elem : roundEnv.getElementsAnnotatedWith(org.spongepowered.asm.mixin.Implements.class)) {
/* 184 */       if (elem.getKind() == ElementKind.CLASS || elem.getKind() == ElementKind.INTERFACE) {
/* 185 */         AnnotationHandle implementsAnnotation = AnnotationHandle.of(elem, org.spongepowered.asm.mixin.Implements.class);
...
/* Location:              D:\工程开发\Cracked\phosphor-1.12.2-0.2.6+build50-universal.jar!\org\spongepowered\tools\obfuscation\MixinObfuscationProcessorTargets.class
