...
/*     */ 
/*     */     
/*  56 */     public boolean shouldRemap() { return this.shouldRemap; }
/*     */   }
/*     */ 
/*     */ 
/*     */ 
/*     */   
/*  62 */   AnnotatedMixinElementHandlerOverwrite(IMixinAnnotationProcessor ap, AnnotatedMixin mixin) { super(ap, mixin); }
/*     */ 
/*     */ 
/*     */   
/*  66 */   public void registerMerge(ExecutableElement method) { validateTargetMethod(method, null, new AnnotatedMixinElementHandler.AliasedElementName(method, AnnotationHandle.MISSING), "overwrite", true, true); }
/*     */ 
/*     */   
...
/*  71 */     validateTargetMethod((ExecutableElement)elem.getElement(), elem.getAnnotation(), name, "@Overwrite", true, false);
/*  72 */     checkConstraints((ExecutableElement)elem.getElement(), elem.getAnnotation());
/*     */     
...
/*     */       
/*     */       try {
/* 111 */         Method md = ((ExecutableElement)elem.getElement()).getClass().getMethod("isStatic", new Class[0]);
...
/* 126 */       elem.printMessage(this.ap, Diagnostic.Kind.ERROR, "Mapping conflict for @Overwrite method: " + ex.getNew().getSimpleName() + " for target " + target + " conflicts with existing mapping " + ex
...
/* Location:              D:\工程开发\Cracked\phosphor-1.12.2-0.2.6+build50-universal.jar!\org\spongepowered\tools\obfuscation\AnnotatedMixinElementHandlerOverwrite.class
